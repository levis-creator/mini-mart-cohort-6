<script setup>
import { AlignJustify, Search, ShoppingCart } from 'lucide-vue-next'
const menuItems = [
  {
    title: 'Home',
    link: '/',
    ...
    >
      ...
      >
        ...
        >
          ...
          <ShoppingCart class="shrink-0 size-4" />
        </button>
        <button
          type="button"
        ...
        <div class="lg:hidden">
          ...
          >
            <AlignJustify class="hs-collapse-open:hidden shrink-0 size-4" />
          </button>
        </div>
      </div>
      <!-- End Button Group -->
